...
public class SchoolController {
    ...
    private final SchoolDaoImpl schoolDaoImpl;
    ...
    public School findSchoolByID(@PathVariable("SchoolID") int schoolID) {
        ...
        School school = schoolDaoImpl.findById(schoolID);

        if(school == null) {
            throw new RuntimeException("StudentID or TeacherID is not found : " + schoolID);
        }
